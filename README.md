...
6. В описании стилей очень нежелательно использовать каскад. Например, `.page-header .subheader {...}`.
    ...
    ```
7. Не должно быть каскада с тегами. Такое написание запрещено: `.page-header h2 {...}` Каскад из нескольких тегов
   неминуемо приведет вас к ошибкам, которые проявятся в самый неожиданный момент.
    ```css
    /* Плохо */
    header ul li {
        padding: 1em;
